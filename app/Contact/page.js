...
function ContactForm() {
    ...
    if (state.succeeded) {
        return (
            <>
                <p className='mb-4 text-center font-mono font-bold text-sky-400'>Thanks for your submission!</p>
            </>
        );
    ...
    return (
        <>
            <form className='mt-40 md:mt-0 md:px-0 px-12 md:mb-0 mb-40 bg-black' onSubmit={handleSubmit}>
