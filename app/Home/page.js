                ...
                <nav className="bg-black fixed w-full z-20 top-0 left-0 border-b">
                  ...
                  <div className="grid grid-cols-2 gap-32">
                    ...
                    <div className="flex flex-row space-x-1 justify-end mx-auto p-4">
                      ...
                      <div ref={ref} className="absolute top-0 -left-2 z-50 w-96 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-black" tabIndex="-1">
                        <div className="text-base font-semibold font-mono text-sky-400">Notification</div>
                        <button onClick={toggleCart} type="button" className="text-gray-400 bg-transparent hover:bg-sky-500 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-6 inline-flex items-center" >
