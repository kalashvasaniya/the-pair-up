                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                                ...
                                <button style={{backgroundColor: '#00B2FF'}} type="submit"
                                    className="w-full bg-sky-400 hover:bg-sky-500 text-white hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:scale-105">
                                    Login
                                </button>
