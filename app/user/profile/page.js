    ...
    <>
      <div className="bg-black text-white">
        <div className="md:grid md:grid-cols-12 flex flex-col">
            ...
            <div className="md:grid md:grid-cols-12 flex flex-row mt-8 space-x-4">
              ...
              <div className="md:grid flex flex-col space-x-20">
                ...
                <div className="md:grid flex col-start-5 col-end-13">
                  <div className="flex flex-col mt-8 justify-start text-base font-medium items-start">
                    <div className="flex flex-row justify-center items-center pl-0">
                      <Link href={''} className='p-1 px-4 rounded-2xl hover:scale-105 bg-sky-400 mr-4'>Edit Profile</Link>
                      <Link href={''} className='p-1 px-4 rounded-2xl hover:scale-105 bg-sky-400'>Find one</Link>
          ...
          {/* Mobile  */}
          <div className="md:hidden block">k</div>
        </div>
      </div >
    </>
  )
